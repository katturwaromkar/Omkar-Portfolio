...
function ContactRow({
  ...
  const inner = (
    <div className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--surface-1)] px-4 py-3.5 transition-colors hover:border-[var(--brand-2)]/50">
      <div className="flex items-center gap-3">
