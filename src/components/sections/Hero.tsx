      ...
      >
        ...
        <div className="text-center lg:text-left">
          ...
          <motion.h1
            ...
            className="mt-6 text-balance text-4xl font-extrabold leading-[1.08] tracking-tight sm:text-6xl xl:text-7xl"
          >
            Hi, I&apos;m{" "}
          ...
          <motion.div
            ...
            className="mt-4 flex items-center justify-center gap-2 text-xl font-semibold text-[var(--text-muted)] sm:text-3xl lg:justify-start"
          >
            <Sparkles size={20} className="shrink-0 text-[var(--brand-3)]" />
            <span className="text-[var(--text)]">{role}</span>
            <span className="ml-0.5 inline-block h-6 w-[3px] animate-pulse bg-[var(--brand-2)]" />
          </motion.div>
