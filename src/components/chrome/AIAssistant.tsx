      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="glass-strong fixed bottom-24 right-3 z-50 flex h-[min(560px,78vh)] w-[calc(100vw-1.5rem)] max-w-[380px] flex-col overflow-hidden rounded-3xl shadow-[var(--shadow-lg)] sm:right-6"
            role="dialog"
